...
namespace RPG.DataManagement
{
    ...
    public class Being : DatabaseElement
    {
        ...
        [SerializeField] float _maxActionPoint;
        [HideInInspector] float _currentActionPoint;
        ...
        public void init(Being being)
        {
            ...
            _currentLife = being.currentLife;
            _maxActionPoint = being.maxActionPoint;
            _currentActionPoint = being.currentActionPoint;
