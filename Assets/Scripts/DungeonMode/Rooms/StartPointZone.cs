...
namespace RPG.DungeonMode.Dungeon
{
    public class StartPointZone : MonoBehaviour
    {
        ...
        [SerializeField] List<ActorSpawningPoint> _actorSpawningPoints = new List<ActorSpawningPoint>();
        public List<ActorSpawningPoint> actorSpawningPoints => _actorSpawningPoints;
